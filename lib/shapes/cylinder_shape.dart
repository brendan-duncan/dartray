...
class CylinderShape extends Shape {
  static CylinderShape Create(Transform o2w, Transform w2o,
    ...
    return new CylinderShape(o2w, w2o, reverseOrientation,
                             radius, zmin, zmax, phimax);
  }

  CylinderShape(Transform o2w, Transform w2o, bool ro, this.radius,
