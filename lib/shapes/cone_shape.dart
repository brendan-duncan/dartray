...
class ConeShape extends Shape {
  static ConeShape Create(Transform o2w, Transform w2o,
    ...
    return new ConeShape(o2w, w2o, reverseOrientation, height, radius, phimax);
  }

  ConeShape(Transform o2w, Transform w2o, bool ro,
